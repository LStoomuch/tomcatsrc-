...
public final class Bootstrap {
    ...
    private void initClassLoaders() {
        try {
            ...
            //这里可以看下，如果找不到配置文件中的 key 的时候或者 key 对应的 value 为空的时候回返回 null，那commonLoader就会被设置为AppClassLoader
            ClassLoader debug = this.getClass().getClassLoader();
    ...
    private ClassLoader createClassLoader(String name, ClassLoader parent)
        ...
        //这里从/org/apache/catalina/startup/catalina.properties 配置文件里获取jar包位置
...
//        初始化 classLoader
        ...
        //利用反射调用该实例的setParentClassLoader 方法, 参数为 sharedLoader, 表示该实例的父类加载器为 sharedLoader
        Method method =
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (command.equals("startd")) {
                ...
                daemon.load(args);
                NioEndpoint              if (null==daemon.getServer()) {
                    System.exit(1);
                }
                System.exit(0);
            } else {
